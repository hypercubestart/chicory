        ...
        return ImportValues.builder()
                ...
                .addFunction(
                        new HostFunction(
                                "spectest",
                                "print_f32",
                                FunctionType.of(List.of(NewValueType.F32), List.of()),
                                noop))
                .addFunction(
                        new HostFunction(
                                "spectest",
                                "print_i32_f32",
                                FunctionType.of(
                                        List.of(NewValueType.I32, NewValueType.F32), List.of()),
                                noop))
                .addFunction(
                        new HostFunction(
                                "spectest",
                ...
                .addFunction(
                        new HostFunction(
                                "spectest",
                                "print_f64",
                                FunctionType.of(List.of(NewValueType.F64), List.of()),
                                noop))
                .addFunction(
                        new HostFunction(
                                "spectest",
                                "print_f64_f64",
                                FunctionType.of(
                                        List.of(NewValueType.F64, NewValueType.F64), List.of()),
                                noop))
                .addGlobal(
                        new ImportGlobal(
